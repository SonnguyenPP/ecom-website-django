...
class Category(models.Model):
    cid =   ShortUUIDField(unique=True, max_length=10, length=20, prefix = "cat", alphabet="abcdefgh12345")
...
class Vendor(models.Model):
    vid = ShortUUIDField(unique=True,max_length=10,length = 20 ,prefix = "ven", alphabet = "abcdefgh12345")
    title = models.CharField(max_length=100,default="Nesti")
    image = models.ImageField(upload_to="category",default="vendor.jpg")
    cover_image = models.ImageField(upload_to="category",default="vendor.jpg")
...
class Product(models.Model):
    ...
    type = models.CharField(max_length=100, default="koton",null=True,blank=True)
    stock_count = models.CharField(max_length=100, default="8",null=True,blank=True)
    life = models.CharField(max_length=100,default="10 days",null=True,blank=True)
