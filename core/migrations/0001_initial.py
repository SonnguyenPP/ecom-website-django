    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=20, max_length=10, prefix='cat', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghi12345', length=10, max_length=20, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=20, max_length=10, prefix='ven', unique=True)),
                ('title', models.CharField(default='Nesti', max_length=100)),
                ('image', models.ImageField(default='vendor.jpg', upload_to='category')),
                ('description', models.TimeField(blank=True, default='i am amazing Vendor', null=True)),
